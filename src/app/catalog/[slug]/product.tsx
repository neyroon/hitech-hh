...
export const ProductBlock = ({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[30px] ">
      ...
      <div className="grow">
        <h1 className="text-[24px] font-semibold mb-[20px]">{product.title}</h1>
        ...
        <ButtonsBuy product={product} selectedColorIndex={selectedColorIndex} />
        <div className="mb-[14px] pb-[8px]">
          {selectedColor && <p className="mb-[10px]">Цвет: {selectedColor}</p>}
      ...
      <div className="grow lg:max-w-[246px] shrink-0 flex flex-col gap-[10px]">
        ...
        <div className="  p-[20px] rounded-[8px] bg-bg-grey flex flex-col gap-[20px]">
          ...
          <div>
            <ul className="list-disc">
              <li className="ml-[20px]">Курьером до двери – привезут на дом</li>
              <li className="ml-[20px]">
                В пункте выдачи – можно забрать в CDEK, 5Post, DPD, Boxberry или
                Почте России.
              </li>
              <li className="ml-[20px]">
