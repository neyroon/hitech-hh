              ...
              <div className="bg-white p-[20px] lg:p-[30px] rounded-[10px]">
                <div className="mb-[20px] flex items-center justify-between">
                  ...
                  <span className="text-[24px] font-semibold">
                    {formatPrice(cart.totalPriceWithPromo || cart.totalPrice)}
                  </span>
                </div>
                ...
                {(cart.totalPriceDiscountWithPromo || cart.totalPriceDiscount) -
                  cart.totalPrice >
                  0 && (
                ...
                <Link
                  className="bg-bg-red block text-center mt-[20px] w-full px-[33px] lg:px-[20px] py-[15px] text-[18px] text-white rounded-[4px] cursor-pointer"
                  href="/checkout"
                >
